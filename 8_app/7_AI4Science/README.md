...
* [AI-Newton: A Concept-Driven Physical Law Discovery System without Prior Physical Knowledge](https://arxiv.org/abs/2504.01538)
  * 当前人类科学发现的局限性迫切需要一种新的研究范式。人工智能（AI）的进步虽然提供了一个极具前景的解决方案，但如何使 AI 能够像人类一样进行科学发现仍然是一个尚未解决的挑战。为了应对这一挑战，我们提出了 AI-Newton，这是一个概念驱动的发现系统，能够在无需监督或先验物理知识的情况下，从原始数据中自主推导出物理定律。该系统集成了一个以物理概念为中心的知识库和知识表示，以及一个自主发现工作流程。作为概念验证，我们将 AI-Newton 应用于大量牛顿力学问题。在给定含噪声的实验数据的情况下，该系统利用自主定义的概念成功地重新发现了包括牛顿第二定律、能量守恒定律和万有引力定律在内的基本定律。这一成果标志着在人工智能驱动的自主科学发现方面迈出了重要一步。
